...
from ez_ufo.ez_ufo_launch_cmd_gen import fmt_in_out_path
...
class tofu_cmds(object):
    ...
    def check_8bit(self, cmd, gray256, hmin, hmax):
        if gray256:
            cmd += " --output-bitdepth 8"
    ...
    def get_1step_ct_cmd(self, ctset, out_pattern, ax, args, nviews, WH):
        ...
        cmd = self.check_8bit(cmd, args.gray256, args.hmin, args.hmax)
