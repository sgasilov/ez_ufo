...
from ez_ufo.ez_main import main_tk, clean_tmp_proj_dirs
...
class GUI:
    def __init__(self, A):
        ...
        tmp="Clip histogram and save slices in 8bit"
    ...
    def reco(self):
        args=tk_args(self.e_indir, self.e_tmpdir, self.e_outdir, self.e_bigtif,\
            ...
            self.e_gray256, self.e_hmin, self.e_hmax, \
