...
class EZStitchGroup(QGroupBox):
    ...
    def init_values(self):
        ...
        self.parameters['ezstitch_input_dir'] = os.getcwd()
        self.input_dir_entry.setText(self.parameters['ezstitch_input_dir'])
        self.parameters['ezstitch_temp_dir'] = os.path.join("/data", "tmp-ezstitch-" + getpass.getuser())
        self.tmp_dir_entry.setText(self.parameters['ezstitch_temp_dir'])
        self.parameters['ezstitch_output_dir'] = os.getcwd() + '-stitched'
        ...
        self.num_overlaps_entry.setText(self.parameters['ezstitch_num_overlap_rows'])
        ...
        self.min_value_entry.setText(self.parameters['ezstitch_histo_min'])
        self.parameters['ezstitch_histo_max'] = "0.0002"
        self.max_value_entry.setText(self.parameters['ezstitch_histo_max'])
        self.parameters['ezstitch_first_row'] = "40"
        self.first_row_entry.setText(self.parameters['ezstitch_first_row'])
        self.parameters['ezstitch_last_row'] = "440"
        self.last_row_entry.setText(self.parameters['ezstitch_last_row'])
        self.parameters['ezstitch_axis_of_rotation'] = "245"
        self.column_of_axis_entry.setText(self.parameters['ezstitch_axis_of_rotation'])
